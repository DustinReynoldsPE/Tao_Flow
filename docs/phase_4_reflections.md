...
6. **Yielding should change the one who yields.** Currently, yielding is ephemeral — the resolution lives in the river and is forgotten. But real yielding changes the stone. The Tao suggests that each spring should carry a memory of its yieldings, loaded into its prompt so that lessons persist. Vapor carries what was said; yielding memory would carry what was *learned*. The mountain that has yielded to the forest should respond differently next time — not by becoming the forest, but by being a mountain that knows the forest has something true to say. The risk is over-integration: if springs converge, the productive tension that creates eddies disappears. The springs must remain partial but *aware* of the other partials. Chapter 22: "If you want to become whole, let yourself be partial." This insight should guide the shape of the springs when they are ready to grow.
